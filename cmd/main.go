...
func main() {
	...
	flag.BoolVar(&debug, "debug", true, "Run with debug logging.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a555565e.skycluster-manager.savitestbed.ca",
	...
	clientset, err := corev1client.NewForConfig(mgr.GetConfig())
	if err != nil {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&corev1alpha1.SkyApp{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SkyApp")
			os.Exit(1)
		}
	}
	if err = (&corecontroller.ProviderAttributeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ProviderAttribute")
		os.Exit(1)
	}
	if err = (&corecontroller.DataflowAttributeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
