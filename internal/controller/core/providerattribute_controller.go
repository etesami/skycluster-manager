...
// ProviderAttributeReconciler reconciles a ProviderAttribute object
type ProviderAttributeReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=core.skycluster-manager.savitestbed.ca,resources=providerattributes,verbs=get;list;watch;create;update;patch;delete
...
// Reconcile reconciles the ProviderAttribute object
func (r *ProviderAttributeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// TODO: Remove this section. Providers are provided using configmaps
...
func (r *ProviderAttributeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.ProviderAttribute{}).
		Complete(r)
}
