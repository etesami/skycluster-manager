...
//+kubebuilder:rbac:groups=core.skycluster.savitestbed.ca,resources=skyapps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.skycluster.savitestbed.ca,resources=skyapps/finalizers,verbs=update
